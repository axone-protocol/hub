...
const TermsModal: FC<TermsModalProps> = ({ open, setOpen, openWalletModal }) => {
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className='text-white p-10 w-[50vw] h-[75vh]'>
        <DialogHeader>
        ...
        <DialogFooter className='relative pt-4'>
          <svg className='absolute -top-24 left-0 right-0 w-full h-28' viewBox='0 0 798 68' fill='none' xmlns='http://www.w3.org/2000/svg'>
