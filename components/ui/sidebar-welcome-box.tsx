...
const SidebarWelcomeAxoneBox = () => (
  <Column className={`w-[${WIDTH}px] relative rounded-lg bg-axone-light-blue p-5 m-5 mt-8`}>
    <Title className='mb-0 z-10'>Join The</Title>
    <Title className='mb-0 z-10'>Axone</Title>
    <Title className='mb-0 z-10'>Ecosystem!</Title>
    <ButtonWithIcon variant={'link'} iconSize={40} className='font-bold px-0 pb-0 justify-start z-10 text-axone-dark-blue-2'>GET STARTED</ButtonWithIcon>
